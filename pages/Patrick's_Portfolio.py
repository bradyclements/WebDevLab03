...
def links_section():
    ...
    linkedin_link = f'<a href="{info1.my_linkedin_url}"><img src="{info1.linkedin_image_url}" alt="LinkedIn" width="75" height="75"></a>'
    st.sidebar.markdown(linkedin_link, unsafe_allow_html=True)
    
    st.sidebar.text("Checkout my work")
    github_link = f'<a href="{info1.my_github_url}"><img src="{info1.github_image_url}" alt="Github" width="65" height="65"></a>'
...
def skills_section(programming_data, spoken_data):
    ...
    for spoken, proficiency in spoken_data.items():
        st.write(f"{spoken} {info1.spoken_icons.get(spoken, '')}: {proficiency}")
